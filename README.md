...
Пункт 3 задания ( Реализовать вывод количества подменю и блюд для Меню через один (сложный) ORM запрос)

реализован в логике модуля menus/crud, а именно в функции get_menu_data
    <details>
